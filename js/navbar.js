...
(function () {
      ...
      xhr.onreadystatechange = function () {
         if (xhr.readyState === 4) {
            if (xhr.status === 200 || (xhr.status === 0 && xhr.responseText)) {
               ...
               console.error(
                  "[Navbar] Failed to load navbar.html - status:",
                  xhr.status
               );
            }
         }
   ...
   function initNavbar() {
      ...
      if (userAvatarImg && auth.userId && auth.serverAddress) {
         var avatarUrl =
            ...
            "/Users/" +
            auth.userId +
            "/Images/Primary?width=80&height=80&quality=90";
         var img = new Image();
         img.onload = function () {
   ...
   function loadUserLibraries() {
      ...
      var existingLibraryButtons = navPill.querySelectorAll(
         ".nav-btn[data-library-id]"
      );
      ...
      if (
         ...
         MultiServerManager.getServerCount() > 0
      ) {
   ...
   function renderLibraryButtons(libraries) {
      ...
      if (navPill && libraries.length > 0) {
         libraries.forEach(function (library) {
            ...
            var serverCount =
               typeof MultiServerManager !== "undefined"
                  ? MultiServerManager.getServerCount()
                  : 0;
            if (library.ServerName && serverCount > 1) {
               label.textContent =
                  library.Name + " (" + library.ServerName + ")";
               ...
               if (library.CollectionType === "livetv") {
                  ...
                  if (library.ServerId) {
                     window.location.href =
                        "live-tv.html?serverId=" + library.ServerId;
                  } else {
   ...
   function setupNavbarHandlers() {
      ...
      if (homeBtn) {
         ...
         homeBtn.addEventListener("focus", function () {
            console.log(
               "[Navbar] homeBtn focused - display:",
               homeBtn.style.display,
               "tabindex:",
               homeBtn.getAttribute("tabindex")
            );
         });
      }
      ...
      if (searchBtn) {
         ...
         searchBtn.addEventListener("focus", function () {
            console.log(
               "[Navbar] searchBtn focused - display:",
               searchBtn.style.display,
               "tabindex:",
               searchBtn.getAttribute("tabindex")
            );
         });
      }
      ...
      if (shuffleBtn) {
         ...
         shuffleBtn.addEventListener("focus", function () {
            console.log(
               "[Navbar] shuffleBtn focused - display:",
               shuffleBtn.style.display,
               "tabindex:",
               shuffleBtn.getAttribute("tabindex")
            );
         });
      }
      ...
      if (genresBtn) {
         ...
         genresBtn.addEventListener("focus", function () {
            console.log(
               "[Navbar] genresBtn focused - display:",
               genresBtn.style.display,
               "tabindex:",
               genresBtn.getAttribute("tabindex")
            );
         });
      }
      ...
      if (favoritesBtn) {
         ...
         favoritesBtn.addEventListener("focus", function () {
            console.log(
               "[Navbar] favoritesBtn focused - display:",
               favoritesBtn.style.display,
               "tabindex:",
               favoritesBtn.getAttribute("tabindex")
            );
         });
      }
      ...
      if (discoverBtn) {
         ...
         discoverBtn.addEventListener("focus", function () {
            console.log(
               "[Navbar] discoverBtn focused - display:",
               discoverBtn.style.display,
               "tabindex:",
               discoverBtn.getAttribute("tabindex")
            );
         });
      }
      ...
      if (settingsBtn) {
         ...
         settingsBtn.addEventListener("focus", function () {
            console.log(
               "[Navbar] settingsBtn focused - display:",
               settingsBtn.style.display,
               "tabindex:",
               settingsBtn.getAttribute("tabindex")
            );
         });
      }
   ...
   function setupNavbarNavigation() {
      ...
      navButtons.forEach(function (button, index) {
         ...
         button._navKeydownHandler = function (e) {
            ...
            console.log(
               "[Navbar] Navigation - Visible buttons:",
               allButtons.map(function (b) {
            ...
            if (e.keyCode === KeyCodes.LEFT) {
               ...
               if (currentIndex > 0) {
                  console.log(
                     "[Navbar] Moving LEFT to:",
                     allButtons[currentIndex - 1].id ||
                        allButtons[currentIndex - 1].textContent.trim()
                  );
