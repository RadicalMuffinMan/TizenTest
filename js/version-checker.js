...
var VersionChecker = (function () {
   ...
   var GITHUB_API_URL =
      "https://api.github.com/repos/Moonfin-Client/Tizen/releases/latest";
   ...
   function showUpdateModal(releaseInfo) {
      ...
      // Store previous focus BEFORE adding modal to DOM
      ...
      function closeModal() {
         ...
         // Restore focus to browse page - try homeBtn first, then previous element
      ...
      document.addEventListener("keydown", function handleModalKeys(e) {
         if (modal.parentElement) {
            ...
            } else if (e.keyCode === 10182 || e.keyCode === 8) {
               // Back button
               e.preventDefault();
               e.stopPropagation();
               closeModal();
