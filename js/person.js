...
var PersonController = (function () {
   ...
   function cacheElements() {
      ...
      elements.personProfilePlaceholder = document.getElementById(
      ...
      elements.birthplaceContainer = document.getElementById(
         "birthplaceContainer"
      );
      elements.birthplace = document.getElementById("birthplace");
      elements.biographyContainer =
         document.getElementById("biographyContainer");
   ...
   function displayPersonDetails() {
      ...
      if (person.profilePath) {
         var profileUrl = ImageHelper.getTMDBImageUrl(
            person.profilePath,
            "w500"
         );
      ...
      var skeletons = document.querySelectorAll(
         ".skeleton-meta, .skeleton-bio, .skeleton-credits, .skeleton-profile, .skeleton-title"
      );
      ...
      if (person.ProductionLocations && person.ProductionLocations.length > 0) {
         elements.birthplace.textContent =
      ...
      card.addEventListener("click", function () {
         if (type === "movie") {
            window.location.href =
               "jellyseerr-details.html?type=movie&id=" + credit.id;
         } else {
            window.location.href =
               "jellyseerr-details.html?type=tv&id=" + credit.id;
         }
      });
   ...
   function handleCreditsNavigation(event) {
      ...
      var currentList =
         currentSection === "movies"
            ? state.credits.movies
            : state.credits.tvShows;
   ...
   function focusCreditCard() {
      ...
      var container =
         sectionName === "movies" ? elements.moviesList : elements.tvShowsList;
